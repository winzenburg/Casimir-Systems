...
export const metadata: Metadata = {
  title: 'SBIR & Government Focus — SF254-D1201',
  description: 'Casimir Intelligence was purpose-built in response to SBIR solicitation SF254-D1201 from U.S. Space Force Task Force Futures. Direct-to-Phase II platform for S&T co-investment decision support.',
};
